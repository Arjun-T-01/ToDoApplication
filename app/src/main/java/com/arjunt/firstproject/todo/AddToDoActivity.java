...
public class AddToDoActivity extends AppCompatActivity {
     ...
     public void showDate()
    {
        ...
        datePickerDialog.getDatePicker().setMinDate(new Date().getTime()); //use Date() in utl.java
    ...
    public void AddToDo(View view) {
        ...
        if(!dateStr.isEmpty() && !timeStr.isEmpty() && !titleStr.isEmpty())
        {
            ...
            if (id > 0)
            {
                Toast.makeText(AddToDoActivity.this, "Item Added Successfully",
                ...
                {
                Toast.makeText(AddToDoActivity.this, "Failed to Add",
                        Toast.LENGTH_SHORT).show();
                }
            ...
            {
                Toast.makeText(AddToDoActivity.this, "Fill all the fields",
                Toast.LENGTH_SHORT).show();
            }
    }
}